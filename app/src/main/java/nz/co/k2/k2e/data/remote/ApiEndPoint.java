...
//    public static final String ENDPOINT_OPEN_SOURCE = BuildConfig.BASE_URL + "/5926c34212000035026871cd";
    public static final String ENDPOINT_WFM = "https://api.k2.co.nz/v1/wfm/";
    public static final String ENDPOINT_JOB = "https://api.k2.co.nz/v1/job/";
    public static final String ENDPOINT = "https://api.k2.co.nz/v1/";
